-- Atomic lead → owner conversion V3.
--
-- Changes from V2:
--   - auth.uid() check (rejects unauthenticated calls)
--   - security definer + set search_path = public, auth
--   - simplified phone normalization (digits only)
--   - proper columns: owners.full_name (not name), owners.company_id
--   - execute grants: authenticated only, revoked from public/anon
--   - uses column names matching the actual schema
