-- Consolidated migration: add all accommodation revenue columns to payments.
-- Idempotent — safe to re-run.
-- Replace 20260702 + 20260709 with this single file.
...
-- 5. Also add expected columns to reservations
